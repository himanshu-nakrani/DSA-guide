...
export function SearchTrigger() {
  return (
    <button
      ...
      className="inline-flex min-h-[44px] items-center gap-1.5 px-2 text-note font-mono uppercase tracking-[0.06em] text-muted-foreground hover:text-ink-blue transition-colors rounded-md outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--ink-blue)]"
    >
